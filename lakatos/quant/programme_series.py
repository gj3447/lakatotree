"""Low-level programme-as-series diagnostic kernel.
...
def series_from_path(
    ...
    *,
    ...
    """
    # quant sibling import. laudan 함수에 실 caller 를 준다.
...
# Preserve the historical pickle/repr import identity while the implementation
# lives below the programme layer.  The compatibility facade exports these exact
# objects, so old payloads still resolve without reintroducing an upward import.
ProgrammeSeriesRecord.__module__ = "lakatos.programme.series"
ProgrammeSeriesAppraisal.__module__ = "lakatos.programme.series"
