...
GROUNDED = {
    ...
    'eprocess_lambda_fraction': {
        ...
        'rationale': '★정직: half-Kelly 류 관례(성장률-분산 절충)이지 GRO 최적화 도출이 아니다. '
                     '방향(2026-07-28 정정): λ↑ = 극단적 대립가설에서 빠른 증식이나 p0 근방 '
                     '검출 영역이 좁아짐, λ↓ = 증식은 느리되 검출 가능 대립가설 영역이 p0 쪽으로 '
                     '넓어짐 — 단순 "보수/공격" 축이 아니다(λ=half-max 는 적중률 [1-1/λ, p0) '
                     '구간의 검출력이 0). 유효성(E[e|H0]<=1)은 λ∈(0,1/(1-p0)) 전 구간 성립.',
    },
    'eprocess_alpha': {
