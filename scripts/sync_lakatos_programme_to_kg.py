...
The default module is `examples.bpc_analysis_contract_programme` — the BPC
...
ENV (for --verify / --apply only):
    ...
    NEO4J_URI       (e.g. bolt://100.64.0.10:55013)   [also accepts NEO4J_URL]
...
The metadata of the target hub (name, scope, hard_core, anchor) is for the BPC
...
# ── target identity (BPC analysis-contract programme) ──────────────────────────
