...
(``tests/fixtures/halcon3d_internet_research.json`` — 12 레코드, 94 실 출처: MVTec 공식문서/arXiv/
...
_FIXTURE = pathlib.Path(__file__).parent / "fixtures" / "halcon3d_internet_research.json"
