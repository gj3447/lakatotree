...
OMD artifact corroborated:
             /data/kjra/PROJECT/PI/omd/CONCURRENCY.md L131 ("가용 = N − count(ACTIVE permit)
             이 구조적으로 복구된다 — 누수 0") & L541 ("증분 7 — D4 ... permit=lease,
             가용 = max − count(ACTIVE) — DONE"); behavioral oracle =
             /data/kjra/PROJECT/PI/omd/tests/test_d4_semaphore.py (run in OMD venv;
...
OMD_ROOT = "/data/kjra/PROJECT/PI/omd"
