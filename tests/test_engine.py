...
from lakatos.io.replay import LineageReplayGate, ReproducibilityContract
...
def test_default_foundation_requirements_are_sparse_and_domain_agnostic():
    ...
    assert all("consumer_b" not in req.name and "ZDF" not in req.name for req in foundation.requirements())
