...
OMD artifact corroborated:
  /data/kjra/PROJECT/PI/omd/spec/omd_connect.tla
  ...
  /data/kjra/PROJECT/PI/omd/spec/omd_connect.cfg  INVARIANTS section.
  Dimension test: /data/kjra/PROJECT/PI/omd/tests/test_d8_connect_splitphase.py
...
OMD_SPEC_DIR = "/data/kjra/PROJECT/PI/omd/spec"
...
_OMD_ROOT = _os.environ.get("OMD_ROOT", "/data/kjra/PROJECT/PI/omd")
