...
OMD ARTIFACT corroborated (real, read-only)
  /data/kjra/PROJECT/PI/omd/CONCURRENCY.md §D7:
...
_OMD_CONCURRENCY_DOC = "/data/kjra/PROJECT/PI/omd/CONCURRENCY.md"
...
def test_mechanism_oracle_rejects_bogus_artifact_path_negative_control():
    ...
    bogus_path = "/data/kjra/PROJECT/PI/omd/CONCURRENCY_NO_SUCH_xyzzy.md"
