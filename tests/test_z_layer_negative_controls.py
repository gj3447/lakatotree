"""rerunnable negative controls — BPC.ZLayerNegativeControlsExecuted.
...
(2개는 실 BPC 증거에 앵커: wrong-layer=feature_z_offset, mirrored-frame=dual_z_frame_gate).
※ 이 테스트는 게이트-수준 판별이다. prismv2 *파이프라인*에 perturbed scan 을 먹이는 전수 실행은 더 깊은
   frontier 로 남는다(README/doc 에 명시). 그래도 "선언만"이 아니라 실행·기록되는 receipt 다.
# KG: CT_LakatoTree_3D_PROM_LonginusReview_20260624 / BPC.ZLayerNegativeControlsExecuted
"""
