...
| `lakatos/lineage.py` | Raw-to-final derivation DAG and stale detection | This is the consumer_b ZDF replayability core. |
...
For consumer_b-like pipelines, every final output must answer:
...
3. Add optional lockfile generators for observed consumer_b/ZDF package layouts.
