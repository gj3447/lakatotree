...
- "BPC feature-fusion path is conditionally viable for demonstrated feature
...
> BPC can be a production candidate only when feature-fusion is the named path.
...
- "LX3 has precision progress through known-axis ArUco; production accuracy is
  still open."

Bad wording:

- "LX3 is accurate because marker registration repeats."
...
> LX3 is not production-accurate until bush-vs-CAD closes. Marker precision is
