/**
 * Pure SHA-256 (FIPS 180-4). No node:crypto so the contracts and domain layers
 * stay free of ambient module imports, mirroring the Python kernel's stdlib-only
 * austerity. Cross-checked against node:crypto in the unit test suite.
 */
