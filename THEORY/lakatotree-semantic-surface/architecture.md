...
The semantic surface is a critical subset of `docs/data/meaning_units.json`, focused
on cross-cutting methodology boundaries that must not drift. It does not replace
the broader meaning registry.

Consequence:

New high-level claims should either enter `docs/data/semantic_surface.json` with an
