...
출처: git 소스(github.com/git/git @ e9019fc, /data/kjra/PROJECT/PI/GIT/git) 8-서브시스템 17-에이전트 해부
...
*전수성*을 구조검증(M0). git 코드구조 1,172 심볼+1,478 CALLS 를 공유 airo KG(GitSource_git_e9019fc)에 적재,
...
_GIT = "git@e9019fc (github.com/git/git, /data/kjra/PROJECT/PI/GIT/git)"
