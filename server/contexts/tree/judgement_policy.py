...
def build_receipt_fields(*, tree: str, tag: str, target_id, verdict: str, metric_name,
                         ...
                         history_payload_sha256: str | None = None,
                         prediction_temporal_commitment_sha256: str | None = None) -> dict:
...
def response_assurance(*, verdict: str, current_receipt_sha: str,
    ...
    S7b: temporal_witness(외부 증인)+attestation+engine floor 가 다 서면 L3 개방(전엔 L2 천장)."""
